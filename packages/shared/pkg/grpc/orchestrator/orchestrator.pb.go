...
// MigrationPrepareSourceRequest tells the source orchestrator to pause its
// running sandbox and become a passive RDMA endpoint serving the destination's
// post-copy reads. The source replies with the qp_info + tcp endpoint the
// destination must connect to, plus the full sandbox config + snapfile bytes
// the destination needs to start a matching FC process.
type MigrationPrepareSourceRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MigrationPrepareSourceRequest) Reset() {
	*x = MigrationPrepareSourceRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MigrationPrepareSourceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrationPrepareSourceRequest) ProtoMessage() {}

func (x *MigrationPrepareSourceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrationPrepareSourceRequest.ProtoReflect.Descriptor instead.
func (*MigrationPrepareSourceRequest) Descriptor() ([]byte, []int) {
	return file_orchestrator_proto_rawDescGZIP(), []int{17}
}

func (x *MigrationPrepareSourceRequest) GetSandboxId() string {
	if x != nil {
		return x.SandboxId
	}
	return ""
...
type MigrationPrepareSourceResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// RDMA endpoint of the source orchestrator's RDMA NIC.
	RdmaAddr  string `protobuf:"bytes,1,opt,name=rdma_addr,json=rdmaAddr,proto3" json:"rdma_addr,omitempty"`      // IPv4 address (RoCE-routed); empty = same as gRPC peer
	TcpPort   uint32 `protobuf:"varint,2,opt,name=tcp_port,json=tcpPort,proto3" json:"tcp_port,omitempty"`        // port chosen by rdma-source agent
	QpInfoHex string `protobuf:"bytes,3,opt,name=qp_info_hex,json=qpInfoHex,proto3" json:"qp_info_hex,omitempty"` // packed qp_info struct, lowercase hex; opaque
	// Sandbox shape needed to start FC on the destination identically.
	Sandbox  *SandboxConfig `protobuf:"bytes,4,opt,name=sandbox,proto3" json:"sandbox,omitempty"`
	Snapfile []byte         `protobuf:"bytes,5,opt,name=snapfile,proto3" json:"snapfile,omitempty"` // FC snapfile bytes (~KB)
	// Memory layout the destination must reproduce. base_host_virt_addr is the
	// VA where FC mmap'd the memfd on the source; the dest must arrange for FC
	// to mmap at the SAME VA so fault VAs match offsets in the source MR. For
	// multi-region sandboxes, repeated entries are returned in declared order.
	MemoryRegions []*MigrationMemoryRegion `protobuf:"bytes,6,rep,name=memory_regions,json=memoryRegions,proto3" json:"memory_regions,omitempty"`
}

func (x *MigrationPrepareSourceResponse) Reset() {
	*x = MigrationPrepareSourceResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *MigrationPrepareSourceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrationPrepareSourceResponse) ProtoMessage() {}

func (x *MigrationPrepareSourceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrationPrepareSourceResponse.ProtoReflect.Descriptor instead.
func (*MigrationPrepareSourceResponse) Descriptor() ([]byte, []int) {
	return file_orchestrator_proto_rawDescGZIP(), []int{18}
}

func (x *MigrationPrepareSourceResponse) GetRdmaAddr() string {
	if x != nil {
		return x.RdmaAddr
	}
	return ""
...
func (x *MigrationPrepareSourceResponse) GetTcpPort() uint32 {
	if x != nil {
		return x.TcpPort
	}
	return 0
...
func (x *MigrationPrepareSourceResponse) GetQpInfoHex() string {
	if x != nil {
		return x.QpInfoHex
	}
	return ""
...
func (x *MigrationPrepareSourceResponse) GetSandbox() *SandboxConfig {
	if x != nil {
		return x.Sandbox
	}
	return nil
...
func (x *MigrationPrepareSourceResponse) GetSnapfile() []byte {
	if x != nil {
		return x.Snapfile
	}
	return nil
...
func (x *MigrationPrepareSourceResponse) GetMemoryRegions() []*MigrationMemoryRegion {
	if x != nil {
...
type MigrationMemoryRegion struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BaseHostVirtAddr uint64 `protobuf:"varint,1,opt,name=base_host_virt_addr,json=baseHostVirtAddr,proto3" json:"base_host_virt_addr,omitempty"` // FC-side VA
	Size             uint64 `protobuf:"varint,2,opt,name=size,proto3" json:"size,omitempty"`                                                     // bytes
	Offset           uint64 `protobuf:"varint,3,opt,name=offset,proto3" json:"offset,omitempty"`                                                 // offset within the memfd
	PageSize         uint64 `protobuf:"varint,4,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`                             // hugepage size
}

func (x *MigrationMemoryRegion) Reset() {
	*x = MigrationMemoryRegion{}
	if protoimpl.UnsafeEnabled {
...
func (x *MigrationMemoryRegion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrationMemoryRegion) ProtoMessage() {}

func (x *MigrationMemoryRegion) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrationMemoryRegion.ProtoReflect.Descriptor instead.
func (*MigrationMemoryRegion) Descriptor() ([]byte, []int) {
	return file_orchestrator_proto_rawDescGZIP(), []int{19}
}

func (x *MigrationMemoryRegion) GetBaseHostVirtAddr() uint64 {
	if x != nil {
		return x.BaseHostVirtAddr
	}
	return 0
}

func (x *MigrationMemoryRegion) GetSize() uint64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *MigrationMemoryRegion) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *MigrationMemoryRegion) GetPageSize() uint64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
// MigrationCommitRequest tells the source orchestrator that the destination
// has finished pulling all pages and is now serving the sandbox. The source
// SIGKILLs its local FC and returns. After this RPC succeeds, the migration
// is complete and the source's sandbox state is gone.
...
func (x *MigrationCommitRequest) GetSandboxId() string {
	if x != nil {
		return x.SandboxId
	}
	return ""
...
// MigrationAbortRequest tells the source orchestrator the destination
// failed/cancelled. Source resumes its FC if possible and returns to running
// state. Best-effort: if FC cannot resume, the sandbox is killed (callers
// then fall back to GCS snapshot path).
...
func (x *MigrationAbortRequest) Reset() {
	*x = MigrationAbortRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MigrationAbortRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrationAbortRequest) ProtoMessage() {}

func (x *MigrationAbortRequest) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrationAbortRequest.ProtoReflect.Descriptor instead.
func (*MigrationAbortRequest) Descriptor() ([]byte, []int) {
	return file_orchestrator_proto_rawDescGZIP(), []int{21}
}

func (x *MigrationAbortRequest) GetSandboxId() string {
	if x != nil {
		return x.SandboxId
	}
	return ""
...
func (x *MigrationAbortRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
// MigrationReceiveRequest is sent by the API to the destination orchestrator,
// carrying everything from PrepareMigrationSource plus the source's RDMA
// connection details. The destination spawns rdma-dest, starts FC against the
// snapfile, and resumes the sandbox in post-copy mode.
type MigrationReceiveRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Carry the full PrepareMigrationSource response verbatim.
	Source    *MigrationPrepareSourceResponse `protobuf:"bytes,1,opt,name=source,proto3" json:"source,omitempty"`
	StartTime *timestamppb.Timestamp          `protobuf:"bytes,2,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	EndTime   *timestamppb.Timestamp          `protobuf:"bytes,3,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
}
...
func (x *MigrationReceiveRequest) GetSource() *MigrationPrepareSourceResponse {
	if x != nil {
		return x.Source
	}
	return nil
...
type MigrationReceiveResponse struct {
	...
	// The orchestrator client_id of this destination, mirroring SandboxCreate.
	ClientId string `protobuf:"bytes,1,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`
	// Pages already pulled when the destination's FC went runnable. Diagnostic.
	PrefetchPagesDone  uint64 `protobuf:"varint,2,opt,name=prefetch_pages_done,json=prefetchPagesDone,proto3" json:"prefetch_pages_done,omitempty"`
	PrefetchPagesTotal uint64 `protobuf:"varint,3,opt,name=prefetch_pages_total,json=prefetchPagesTotal,proto3" json:"prefetch_pages_total,omitempty"`
	FaultsHandled      uint64 `protobuf:"varint,4,opt,name=faults_handled,json=faultsHandled,proto3" json:"faults_handled,omitempty"`
}
...
func (x *MigrationReceiveResponse) GetPrefetchPagesDone() uint64 {
	if x != nil {
		return x.PrefetchPagesDone
	}
	return 0
}

func (x *MigrationReceiveResponse) GetPrefetchPagesTotal() uint64 {
	if x != nil {
		return x.PrefetchPagesTotal
	}
	return 0
}

func (x *MigrationReceiveResponse) GetFaultsHandled() uint64 {
	if x != nil {
		return x.FaultsHandled
	}
	return 0
}
...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x75, 0x6d, 0x65, 0x22, 0x5a, 0x0a, 0x17, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78,
	...
	0x52, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x69, 0x6d, 0x65,
	...
	0x73, 0x22, 0x60, 0x0a, 0x12, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x56, 0x6f, 0x6c, 0x75,
	0x6d, 0x65, 0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	,
	...
	0x28, 0x09, 0x52, 0x08, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0xc3, 0x01, 0x0a,
	0x14, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	,
	...
	0x28, 0x09, 0x52, 0x07, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x22, 0x54, 0x0a, 0x18, 0x53,
	0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x4b, 0x0a, 0x1f, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x4c, 0x69, 0x73, 0x74,
	0x43, 0x61, 0x63, 0x68, 0x65, 0x64, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x06, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x43, 0x61, 0x63, 0x68, 0x65, 0x64, 0x42, 0x75, 0x69,
	0x6c, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x22, 0x3e,
	0x0a, 0x1d, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x65, 0x70, 0x61,
	...
	,
	...
	0x22, 0x37, 0x0a, 0x16, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6d,
	0x6d, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x61,
	0x6e, 0x64, 0x62, 0x6f, 0x78, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x73, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x49, 0x64, 0x22, 0x4e, 0x0a, 0x15, 0x4d, 0x69, 0x67,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x62, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xc4, 0x01, 0x0a, 0x17, 0x4d, 0x69,
	0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x37, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x39,
	...
	,
	...
	0x0a, 0x0a, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x19, 0x2e, 0x53,
	0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f,
	0x78, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x4c, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x63, 0x68, 0x65,
	...
	,
...
var file_orchestrator_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_orchestrator_proto_goTypes = []interface{}{
	...
	(*SandboxNetworkEgressConfig)(nil),      // 4: SandboxNetworkEgressConfig
	(*SandboxNetworkIngressConfig)(nil),     // 5: SandboxNetworkIngressConfig
	(*SandboxCreateRequest)(nil),            // 6: SandboxCreateRequest
	(*SandboxCreateResponse)(nil),           // 7: SandboxCreateResponse
	(*SandboxUpdateRequest)(nil),            // 8: SandboxUpdateRequest
	(*SandboxDeleteRequest)(nil),            // 9: SandboxDeleteRequest
	(*SandboxPauseRequest)(nil),             // 10: SandboxPauseRequest
	(*SandboxCheckpointRequest)(nil),        // 11: SandboxCheckpointRequest
	(*SandboxCheckpointResponse)(nil),       // 12: SandboxCheckpointResponse
	(*RunningSandbox)(nil),                  // 13: RunningSandbox
	(*SandboxListResponse)(nil),             // 14: SandboxListResponse
	(*CachedBuildInfo)(nil),                 // 15: CachedBuildInfo
	(*SandboxListCachedBuildsResponse)(nil), // 16: SandboxListCachedBuildsResponse
	(*MigrationPrepareSourceRequest)(nil),   // 17: MigrationPrepareSourceRequest
	(*MigrationPrepareSourceResponse)(nil),  // 18: MigrationPrepareSourceResponse
	(*MigrationMemoryRegion)(nil),           // 19: MigrationMemoryRegion
	(*MigrationCommitRequest)(nil),          // 20: MigrationCommitRequest
	(*MigrationAbortRequest)(nil),           // 21: MigrationAbortRequest
	(*MigrationReceiveRequest)(nil),         // 22: MigrationReceiveRequest
	(*MigrationReceiveResponse)(nil),        // 23: MigrationReceiveResponse
...
var file_orchestrator_proto_depIdxs = []int32{
	...
	4,  // 5: SandboxNetworkConfig.egress:type_name -> SandboxNetworkEgressConfig
	5,  // 6: SandboxNetworkConfig.ingress:type_name -> SandboxNetworkIngressConfig
	0,  // 7: SandboxCreateRequest.sandbox:type_name -> SandboxConfig
	26, // 8: SandboxCreateRequest.start_time:type_name -> google.protobuf.Timestamp
	26, // 9: SandboxCreateRequest.end_time:type_name -> google.protobuf.Timestamp
	26, // 10: SandboxUpdateRequest.end_time:type_name -> google.protobuf.Timestamp
	4,  // 11: SandboxUpdateRequest.egress:type_name -> SandboxNetworkEgressConfig
	0,  // 12: RunningSandbox.config:type_name -> SandboxConfig
	26, // 13: RunningSandbox.start_time:type_name -> google.protobuf.Timestamp
	26, // 14: RunningSandbox.end_time:type_name -> google.protobuf.Timestamp
	13, // 15: SandboxListResponse.sandboxes:type_name -> RunningSandbox
	26, // 16: CachedBuildInfo.expiration_time:type_name -> google.protobuf.Timestamp
	15, // 17: SandboxListCachedBuildsResponse.builds:type_name -> CachedBuildInfo
	0,  // 18: MigrationPrepareSourceResponse.sandbox:type_name -> SandboxConfig
	19, // 19: MigrationPrepareSourceResponse.memory_regions:type_name -> MigrationMemoryRegion
	18, // 20: MigrationReceiveRequest.source:type_name -> MigrationPrepareSourceResponse
	26, // 21: MigrationReceiveRequest.start_time:type_name -> google.protobuf.Timestamp
	26, // 22: MigrationReceiveRequest.end_time:type_name -> google.protobuf.Timestamp
	6,  // 23: SandboxService.Create:input_type -> SandboxCreateRequest
	8,  // 24: SandboxService.Update:input_type -> SandboxUpdateRequest
	27, // 25: SandboxService.List:input_type -> google.protobuf.Empty
	9,  // 26: SandboxService.Delete:input_type -> SandboxDeleteRequest
	10, // 27: SandboxService.Pause:input_type -> SandboxPauseRequest
	11, // 28: SandboxService.Checkpoint:input_type -> SandboxCheckpointRequest
	27, // 29: SandboxService.ListCachedBuilds:input_type -> google.protobuf.Empty
	17, // 30: SandboxService.PrepareMigrationSource:input_type -> MigrationPrepareSourceRequest
	20, // 31: SandboxService.CommitMigration:input_type -> MigrationCommitRequest
	21, // 32: SandboxService.AbortMigration:input_type -> MigrationAbortRequest
	22, // 33: SandboxService.ReceiveMigration:input_type -> MigrationReceiveRequest
	7,  // 34: SandboxService.Create:output_type -> SandboxCreateResponse
	27, // 35: SandboxService.Update:output_type -> google.protobuf.Empty
	14, // 36: SandboxService.List:output_type -> SandboxListResponse
	27, // 37: SandboxService.Delete:output_type -> google.protobuf.Empty
	27, // 38: SandboxService.Pause:output_type -> google.protobuf.Empty
	12, // 39: SandboxService.Checkpoint:output_type -> SandboxCheckpointResponse
	16, // 40: SandboxService.ListCachedBuilds:output_type -> SandboxListCachedBuildsResponse
	18, // 41: SandboxService.PrepareMigrationSource:output_type -> MigrationPrepareSourceResponse
	27, // 42: SandboxService.CommitMigration:output_type -> google.protobuf.Empty
	27, // 43: SandboxService.AbortMigration:output_type -> google.protobuf.Empty
	23, // 44: SandboxService.ReceiveMigration:output_type -> MigrationReceiveResponse
...
func file_orchestrator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_orchestrator_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MigrationPrepareSourceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_orchestrator_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MigrationPrepareSourceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_orchestrator_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MigrationMemoryRegion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_orchestrator_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MigrationCommitRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_orchestrator_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MigrationAbortRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_orchestrator_proto_msgTypes[8].OneofWrappers = []interface{}{}
	type x struct{}
